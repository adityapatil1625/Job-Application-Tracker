...
const UpcomingInterviews = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border-2 border-orange-200 dark:border-orange-700 bg-gradient-to-r from-orange-50 dark:from-orange-900 to-red-50 dark:to-red-900 p-6">
